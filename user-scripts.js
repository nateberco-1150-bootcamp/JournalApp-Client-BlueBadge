...
************************** */
function userSignUp() {
    console.log('userSignUp Function Called') //take out later!
...
.catch((err) => {
    ...
    ************************** */
    function userLogin() {
     console.log('userLogin Function Called!') //take out later
    ...
    ************************** */
    function userLogout() {
     console.log('userLogout Function Called') //remove
